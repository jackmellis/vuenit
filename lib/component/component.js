...
var hasOwn = require('../helpers').hasOwn;
...
function mergeDirectives(component, options) {
  ...
  component.directives = Object.assign({}, component.directives, options.directives);
}
  ...
  if (options.data){
    ...
    component.data = function () {
      ...
      if (typeof options.data === 'function'){
        Object.assign(data, options.data.call(this, data));
      }else{
...
function componentName(component, options) {
  var name = isComponent(component) ?
    component.name || options.name || ('test-component-' + Math.floor(Math.random() * 1024)) :
    component;
